...
from app.api.routes import his_push, websocket_manager, ai_proxy
...
def create_app() -> FastAPI:
    ...
    app.include_router(admin_routes.router, prefix="/api/admin", tags=["管理端接口"])
    # app.include_router(ai_proxy.router, prefix="/api", tags=["AI代理接口"])
